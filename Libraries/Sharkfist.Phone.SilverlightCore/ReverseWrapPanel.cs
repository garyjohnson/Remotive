...
namespace Sharkfist.Phone.SilverlightCore
{
    ...
    public partial class ReverseWrapPanel : Panel
    {
        /// <summary>
        ...
        {
            ReverseWrapPanel source = (ReverseWrapPanel)d;
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            bool hasFixedWidth = !itemWidth.IsNaN();
            bool hasFixedHeight = !itemHeight.IsNaN();
            double indirectOffset = maximumSize.Indirect;
        ...
        private void ArrangeLine(int lineStart, int lineEnd, double? directDelta, double indirectOffset, double indirectGrowth)
        {
            ...
            for (int index = lineStart; index < lineEnd; index++)
            {
                ...
                Rect bounds = isHorizontal ?
                    new Rect(directOffset, indirectOffset - indirectGrowth, directGrowth, indirectGrowth) :
                    new Rect(indirectOffset - indirectGrowth, directOffset, indirectGrowth, directGrowth);
